					...
					<!-- start: page -->
						<section class="panel">
							...
							<div class="panel-body">
								<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('report/dailyEquipmentBookingOpPositionAction') ?>">
									<div class="form-group">
										<div class="col-md-offset-3 col-md-6">
												<div class="input-group mb-md">
													...
													<!--input type="date" name="eqpdate" id="date" class="form-control" -->
												</div>
										</div>
										<div class="col-md-7 col-md-offset-3">
											<div class="row">
												<div class="col-md-6">
													<div class="input-group mb-md">
														<span class="input-group-addon">Shift No</span>
														<select name="shift_no" id="shift_no">  
														<option value="">--------Select--------</option>
														<?php if($editFlag==1){?> 
														<option value="<?php echo $select_result[0]['shift']; ?>" selected="true"><?php echo $select_result[0]['shift']; ?></option>
														<?php }  ?>												
												...
												<div class="col-md-6">
													<div class="input-group mb-md">
														<span class="input-group-addon">Terminal No</span>
														<select name="gcb" id="gcb">  										
							...
							<br>
							<div class="panel-body">
								<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('report/dailyEquipmentBookingOpPositionSearch') ?>" onSubmit="return chkSearchInput()">
									<div class="form-group">
										<div class="col-md-offset-3 col-md-6">
											<div class="input-group mb-md">
												<span class="input-group-addon span_width">Date</span>
								...
								<table class="table table-bordered table-hover table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td align="center">
												<form action="<?php echo site_url('report/dailyEquipmentBookingOpPositionEdit');?>" method="POST">
											...
											<td align="center">
												<form action="<?php echo site_url('report/dailyEquipmentBookingOpPosition');?>" method="POST" onsubmit="return validate();">
